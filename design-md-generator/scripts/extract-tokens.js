#!/usr/bin/env node
/**
 * extract-tokens.js — LEGACY: Extract design tokens from a URL via Puppeteer/CDP
 *
 * DEPRECATED: Prefer extract-tokens-inline.js with OpenClaw's browser tool.
 * This script requires Node.js + Puppeteer (npm install puppeteer) which
 * bundles a ~400MB Chromium download. Use only when OpenClaw browser is
 * unavailable AND you have a Node.js environment with Puppeteer installed.
 *
